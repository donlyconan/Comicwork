    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-header" style="margin-left: 10px">STATISTIC</li>
                ...
                <li class="nav-item has-treeview ">
                    ...
                    <ul class="nav nav-treeview ">
                        <li class="nav-item active">
                            <a href="{{ route('admin.comicworks.index') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>List Comicworks</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('admin.comicworks.create')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Add Comicworks</p>
                            </a>
                        </li>
