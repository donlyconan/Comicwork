...
@section('content')
    ...
    @include('admin.admin-patials.content-header', ['name' => 'Roles', 'action' => 'List', 'route' => 'http://127.0.0.1:8000/admin/roles/index'])
...
{{--                                                           href="{{route('admin.roles.show', ['id' => $row->id])}}">--}}
{{--                                                            <i class="fas fa-folder"></i>--}}
{{--                                                            View--}}
{{--                                                        </a>--}}
                                                        <a class="btn btn-info btn-sm"
                                                           href="{{route('admin.roles.edit', ['id' => $row->id])}}">
                                                        ...
                                                        <a class="btn btn-danger btn-sm delete-record" href=""
                                                           ...
                                                           data-url="{{route('admin.roles.destroy', ['id' => $row->id])}}">
