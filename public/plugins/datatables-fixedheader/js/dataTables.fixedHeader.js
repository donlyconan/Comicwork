...
$.extend( FixedHeader.prototype, {
	 ...
	 * for the footer as the footer in the content table takes its sizes from the
	 ...
	 * when inserting the footer back into the content table so the size is defined
	 ...
	 * of:
	 *
	 * * `in-place` - In the content DataTable
	...
	_positions: function ()
	{
		...
		// Need to use the header and footer that are in the content table,
