...
var FixedColumns = function ( dt, init ) {
	...
	this.dom = {
		...
		"grid": {
			 ...
			 * component in the display grid (making up the content table - i.e.
...
$.extend( FixedColumns.prototype , {
	 ...
	 * tables and get the index position for the data in the content table.
	...
	"_fnConstruct": function ( oInit )
	{
		 ...
		 * another redraw of the content table. It doesn't need to be a full redraw however.
		 */
		this._fnGridLayout();
