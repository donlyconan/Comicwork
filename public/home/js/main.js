!function (e, t) {
    ...
    var d = [], u = d.slice, m = d.concat, a = d.push, o = d.indexOf, n = {}, i = n.toString, g = n.hasOwnProperty,
        v = {}, s = "1.11.1", C = function (e, t) {
    ...
    C.fn = C.prototype = {
        ...
        }, push: a, sort: d.sort, splice: d.splice
    }, C.extend = C.fn.extend = function () {
        var e, t, n, i, o, s, r = arguments[0] || {}, a = 1, l = arguments.length, c = !1;
        for ("boolean" == typeof r && (c = r, r = arguments[a] || {}, a++), "object" == typeof r || C.isFunction(r) || (r = {}), a === l && (r = this, a--); a < l; a++) if (null != (o = arguments[a])) for (i in o) e = r[i], r !== (n = o[i]) && (c && n && (C.isPlainObject(n) || (t = C.isArray(n))) ? (s = t ? (t = !1, e && C.isArray(e) ? e : []) : e && C.isPlainObject(e) ? e : {}, r[i] = C.extend(c, s, n)) : void 0 !== n && (r[i] = n));
        return r
    }, C.extend({
        expando: "jQuery" + (s + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (e) {
            ...
            var i = 0, o = e.length, s = p(e);
            if (n) {
                if (s) for (; i < o && !1 !== t.apply(e[i], n); i++) ; else for (i in e) if (!1 === t.apply(e[i], n)) break
            ...
            var i, o = 0, s = e.length, r = [];
            if (p(e)) for (; o < s; o++) null != (i = t(e[o], o, n)) && r.push(i); else for (o in e) null != (i = t(e[o], o, n)) && r.push(i);
            return m.apply([], r)
    ...
    var h = function (n) {
        ...
        var e, f, w, s, i, m, p, g, k, c, u, v, x, o, y, b, r, a, C, T = "sizzle" + -new Date, S = n.document, _ = 0,
            h = 0, l = oe(), $ = oe(), A = oe(), E = function (e, t) {
                return e === t && (u = !0), 0
            }, j = "undefined", N = {}.hasOwnProperty, t = [], L = t.pop, D = t.push, H = t.push, O = t.slice,
            z = t.indexOf || function (e) {
                for (var t = 0, n = this.length; t < n; t++) if (this[t] === e) return t;
                return -1
            },
            q = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",
            P = "[\\x20\\t\\r\\n\\f]", M = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", I = M.replace("w", "w#"),
            F = "\\[" + P + "*(" + M + ")(?:" + P + "*([*^$|!~]?=)" + P + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + I + "))|)" + P + "*\\]",
            B = ":(" + M + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + F + ")*)|.*)\\)|)",
            R = new RegExp("^" + P + "+|((?:^|[^\\\\])(?:\\\\.)*)" + P + "+$", "g"),
            W = new RegExp("^" + P + "*," + P + "*"), Q = new RegExp("^" + P + "*([>+~]|" + P + ")" + P + "*"),
            X = new RegExp("=" + P + "*([^\\]'\"]*?)" + P + "*\\]", "g"), U = new RegExp(B),
            K = new RegExp("^" + I + "$"), V = {
                ID: new RegExp("^#(" + M + ")"),
                CLASS: new RegExp("^\\.(" + M + ")"),
        ...
        for (e in f = ie.support = {}, i = ie.isXML = function (e) {
            ...
            var t, l = e ? e.ownerDocument || e : S, n = l.defaultView;
            ...
            filter: {
                TAG: function (e) {
                    ...
                    return 1 === f && 0 === m ? function (e) {
                        ...
                        var i, o, s, r, a, l, c = g != v ? "nextSibling" : "previousSibling", u = e.parentNode,
                            d = y && e.nodeName.toLowerCase(), p = !n && !y;
                        if (u) {
                            if (g) {
                                for (; c;) {
                            ...
                            if (l = [v ? u.firstChild : u.lastChild], v && p) {
                                for (a = (i = (o = u[T] || (u[T] = {}))[h] || [])[0] === _ && i[1], r = i[0] === _ && i[2], s = a && u.childNodes[a]; s = ++a && s && s[c] || (r = a = 0) || l.pop();) if (1 === s.nodeType && ++r && s === e) {
                                    o[h] = [_, a, r];
                                    break
                                }
                            } else if (p && (i = (e[T] || (e[T] = {}))[h]) && i[0] === _) r = i[1]; else for (; (s = ++a && s && s[c] || (r = a = 0) || l.pop()) && ((y ? s.nodeName.toLowerCase() !== d : 1 !== s.nodeType) || !++r || (p && ((s[T] || (s[T] = {}))[h] = [_, r]), s !== e));) ;
            ...
            pseudos: {
                not: se(function (e) {
                    ...
                    return K.test(n || "") || ie.error("unsupported lang: " + n), n = n.replace(ne, d).toLowerCase(), function (e) {
                        var t;
                        do {
        ...
        function me(r, e, t) {
            var a = e.dir, l = t && "parentNode" === a, c = h++;
        ...
        function ye(h, f, m, g, v, e) {
            return g && !g[T] && (g = ye(g)), v && !v[T] && (v = ye(v, e)), se(function (e, t, n, i) {
                var o, s, r, a = [], l = [], c = t.length, u = e || function (e, t, n) {
                        for (var i = 0, o = t.length; i < o; i++) ie(e, t[i], n);
                        return n
                    }(f || "*", n.nodeType ? [n] : n, []), d = !h || !e && f ? u : ve(u, a, h, n, i),
                    p = m ? v || (e ? h : c || g) ? [] : t : d;
        ...
        function be(e) {
            ...
            }]; a < o; a++) if (t = w.relative[e[a].type]) u = [me(ge(u), t)]; else {
        ...
        return he.prototype = w.filters = w.pseudos, w.setFilters = new he, m = ie.tokenize = function (e, t) {
            ...
            if (!s) {
                ...
                (s = A(e, function (g, v) {
                    function e(e, t, n, i, o) {
                        var s, r, a, l = 0, c = "0", u = e && [], d = [], p = k, h = e || b && w.find.TAG("*", o),
                            f = _ += null == p ? 1 : Math.random() || .1, m = h.length;
                        for (o && (k = t !== x && t); c !== m && null != (s = h[c]); c++) {
                            if (b && s) {
                                for (r = 0; a = g[r++];) if (a(s, t, n)) {
                                    i.push(s);
                                    break
                                }
                                o && (_ = f)
            ...
            var o, s, r, a, l, c = "function" == typeof e && e, u = !i && m(e = c.selector || e);
            if (n = n || [], 1 === u.length) {
                ...
                for (o = V.needsContext.test(e) ? 0 : s.length; o-- && (r = s[o], !w.relative[a = r.type]);) if ((l = w.find[a]) && (i = l(r.matches[0].replace(ne, d), ee.test(s[0].type) && pe(t.parentNode) || t))) {
    ...
    var y = C.expr.match.needsContext, b = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, w = /^.[^:#\[\.,]*$/;
    ...
    (C.fn.init = function (e, t) {
        ...
        if (n[1]) {
            if (t = t instanceof C ? t[0] : t, C.merge(this, C.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : T, !0)), b.test(n[1]) && C.isPlainObject(t)) for (n in t) C.isFunction(this[n]) ? this[n](t[n]) : this.attr(n, t[n]);
            return this
        }
    ...
    var _ = /^(?:parents|prev(?:Until|All))/, $ = {children: !0, contents: !0, next: !0, prev: !0};
    ...
    C.extend({
        ...
        has: function (e) {
            ...
            for (var n, i = 0, o = this.length, s = [], r = y.test(e) || "string" != typeof e ? C(e, t || this.context) : 0; i < o; i++) for (n = this[i]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (r ? -1 < r.index(n) : 1 === n.nodeType && C.find.matchesSelector(n, e))) {
                s.push(n);
                break
            }
    ...
    C.Callbacks = function (o) {
        ...
        var i, t, n, s, r, a, l = [], c = !o.once && [], u = function (e) {
            for (t = o.memory && e, n = !0, r = a || 0, a = 0, s = l.length, i = !0; l && r < s; r++) if (!1 === l[r].apply(e[0], e[1]) && o.stopOnFalse) {
                t = !1;
                break
            }
        ...
        Deferred: function (e) {
            ...
            var o, n, i, s = 0, r = u.call(arguments), a = r.length,
        ...
        if (!E) if (E = C.Deferred(), "complete" === T.readyState) setTimeout(C.ready); else if (T.addEventListener) T.addEventListener("DOMContentLoaded", D, !1), f.addEventListener("load", D, !1); else {
    ...
    function I(e, t, n, i) {
        if (C.acceptData(e)) {
            var o, s, r = C.expando, a = e.nodeType, l = a ? C.cache : e, c = a ? e[r] : e[r] && r;
            if (c && l[c] && (i || l[c].data) || void 0 !== n || "string" != typeof t) return c || (c = a ? e[r] = d.pop() || C.guid++ : r), l[c] || (l[c] = a ? {} : {toJSON: C.noop}), "object" != typeof t && "function" != typeof t || (i ? l[c] = C.extend(l[c], t) : l[c].data = C.extend(l[c].data, t)), s = l[c], i || (s.data || (s.data = {}), s = s.data), void 0 !== n && (s[C.camelCase(t)] = n), "string" == typeof t ? null == (o = s[t]) && (o = s[C.camelCase(t)]) : o = s, o
        }
    }

    function F(e, t, n) {
        if (C.acceptData(e)) {
            var i, o, s = e.nodeType, r = s ? C.cache : e, a = s ? e[C.expando] : C.expando;
            if (r[a]) {
    ...
    var R = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, W = ["Top", "Right", "Bottom", "Left"],
        Q = C.access = function (e, t, n, i, o, s, r) {
            var a = 0, l = e.length, c = null == n;
            if ("object" === C.type(n)) for (a in o = !0, n) C.access(e, t, a, n[a], !0, s, r); else if (void 0 !== i && (o = !0, C.isFunction(i) || (r = !0), c && (t = r ? (t.call(e, i), null) : (c = t, function (e, t, n) {
                return c.call(C(e), n)
    ...
    var U = /^(?:input|select|textarea)$/i, K = /^key/, V = /^(?:mouse|pointer|contextmenu)|click/,
        G = /^(?:focusinfocus|focusoutblur)$/, Y = /^([^.]*)(?:\.(.+)|)$/;
    ...
    C.event = {
        ...
        remove: function (e, t, n, i, o) {
            ...
            if (g && (u = g.events)) {
                for (c = (t = (t || "").match(j) || [""]).length; c--;) if (h = m = (a = Y.exec(t[c]) || [])[1], f = (a[2] || "").split(".").sort(), h) {
        ...
        trigger: function (e, t, n, i) {
            var o, s, r, a, l, c, u, d = [n || T], p = g.call(e, "type") ? e.type : e,
            ...
            if (r = c = n = n || T, 3 !== n.nodeType && 8 !== n.nodeType && !G.test(p + C.event.triggered) && (0 <= p.indexOf(".") && (p = (h = p.split(".")).shift(), h.sort()), s = p.indexOf(":") < 0 && "on" + p, (e = e[C.expando] ? e : new C.Event(p, "object" == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = h.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : C.makeArray(t, [e]), l = C.event.special[p] || {}, i || !l.trigger || !1 !== l.trigger.apply(n, t))) {
                ...
                for (u = 0; (r = d[u++]) && !e.isPropagationStopped();) e.type = 1 < u ? a : l.bindType || p, (o = (C._data(r, "events") || {})[e.type] && C._data(r, "handle")) && o.apply(r, t), (o = s && r[s]) && o.apply && C.acceptData(r) && (e.result = o.apply(r, t), !1 === e.result && e.preventDefault());
        ...
        dispatch: function (e) {
            e = C.event.fix(e);
            var t, n, i, o, s, r = [], a = u.call(arguments), l = (C._data(this, "events") || {})[e.type] || [],
                c = C.event.special[e.type] || {};
            if ((a[0] = e).delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, e)) {
                for (r = C.event.handlers.call(this, e, l), t = 0; (o = r[t++]) && !e.isPropagationStopped();) for (e.currentTarget = o.elem, s = 0; (i = o.handlers[s++]) && !e.isImmediatePropagationStopped();) e.namespace_re && !e.namespace_re.test(i.namespace) || (e.handleObj = i, e.data = i.data, void 0 !== (n = ((C.event.special[i.origType] || {}).handle || i.handler).apply(o.elem, a)) && !1 === (e.result = n) && (e.preventDefault(), e.stopPropagation()));
    ...
    }), v.focusinBubbles || C.each({focus: "focusin", blur: "focusout"}, function (n, i) {
        function o(e) {
    ...
    var ne = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        ie = / jQuery\d+="(?:null|\d+)"/g, oe = new RegExp("<(?:" + ne + ")[\\s/>]", "i"), se = /^\s+/,
        re = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, ae = /<([\w:]+)/,
        le = /<tbody/i, ce = /<|&#?\w+;/, ue = /<(?:script|style|link)/i, de = /checked\s*(?:[^=]|=\s*.checked.)/i,
        pe = /^$|\/(?:java|ecma)script/i, he = /^true\/(.*)/, fe = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, me = {
    ...
    function Ce(e, t) {
        if (1 === t.nodeType && C.hasData(e)) {
            var n, i, o, s = C._data(e), r = C._data(t, s), a = s.events;
    ...
    me.optgroup = me.option, me.tbody = me.tfoot = me.colgroup = me.caption = me.thead, me.th = me.td, C.extend({
        clone: function (e, t, n) {
            ...
            if (v.html5Clone || C.isXMLDoc(e) || !oe.test("<" + e.nodeName + ">") ? s = e.cloneNode(!0) : (ge.innerHTML = e.outerHTML, ge.removeChild(s = ge.firstChild)), !(v.noCloneEvent && v.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || C.isXMLDoc(e))) for (i = ve(s), a = ve(e), r = 0; null != (o = a[r]); ++r) i[r] && Te(o, i[r]);
            if (t) if (n) for (a = a || ve(e), i = i || ve(s), r = 0; null != (o = a[r]); r++) Ce(o, i[r]); else Ce(e, s);
            return 0 < (i = ve(s, "script")).length && xe(i, !l && ve(e, "script")), i = a = o = null, s
        }, buildFragment: function (e, t, n, i) {
            for (var o, s, r, a, l, c, u, d = e.length, p = te(t), h = [], f = 0; f < d; f++) if ((s = e[f]) || 0 === s) if ("object" === C.type(s)) C.merge(h, s.nodeType ? [s] : s); else if (ce.test(s)) {
                ...
                if (!v.leadingWhitespace && se.test(s) && h.push(t.createTextNode(se.exec(s)[0])), !v.tbody) for (o = (s = "table" !== l || le.test(s) ? "<table>" !== u[1] || le.test(s) ? 0 : a : a.firstChild) && s.childNodes.length; o--;) C.nodeName(c = s.childNodes[o], "tbody") && !c.childNodes.length && s.removeChild(c);
                for (C.merge(h, a.childNodes), a.textContent = ""; a.firstChild;) a.removeChild(a.firstChild);
                a = p.lastChild
            } else h.push(t.createTextNode(s));
            for (a && p.removeChild(a), v.appendChecked || C.grep(ve(h, "input"), ye), f = 0; s = h[f++];) if ((!i || -1 === C.inArray(s, i)) && (r = C.contains(s.ownerDocument, s), a = ve(p.appendChild(s), "script"), r && xe(a), n)) for (o = 0; s = a[o++];) pe.test(s.type || "") && n.push(s);
            return a = null, p
        }, cleanData: function (e, t) {
            for (var n, i, o, s, r = 0, a = C.expando, l = C.cache, c = v.deleteExpando, u = C.event.special; null != (n = e[r]); r++) if ((t || C.acceptData(n)) && (s = (o = n[a]) && l[o])) {
    ...
    C.fn.extend({
        text: function (e) {
            ...
            n = m.apply([], n);
            var e, t, o, s, r, a, l = 0, c = this.length, u = this, d = c - 1, p = n[0], h = C.isFunction(p);
            ...
            if (c && (e = (a = C.buildFragment(n, this[0].ownerDocument, !1, this)).firstChild, 1 === a.childNodes.length && (a = e), e)) {
                ...
                if (o) for (r = s[s.length - 1].ownerDocument, C.map(s, ke), l = 0; l < o; l++) t = s[l], pe.test(t.type || "") && !C._data(t, "globalEval") && C.contains(r, t) && (t.src ? C._evalUrl && C._evalUrl(t.src) : C.globalEval((t.text || t.textContent || t.innerHTML || "").replace(fe, "")));
                a = e = null
            }
            return this
        }
    ...
    var je, Ne, Le = /^margin/, De = new RegExp("^(" + R + ")(?!px)[a-z%]+$", "i"), He = /^(top|right|bottom|left)$/;
    ...
    var ze = /alpha\([^)]*\)/i, qe = /opacity\s*=\s*([^)]*)/, Pe = /^(none|table(?!-c[ea]).+)/,
        Me = new RegExp("^(" + R + ")(.*)$", "i"), Ie = new RegExp("^([+-])=(" + R + ")", "i"),
        Fe = {position: "absolute", visibility: "hidden", display: "block"},
        Be = {letterSpacing: "0", fontWeight: "400"}, Re = ["Webkit", "O", "Moz", "ms"];
    ...
    function Ke(e, t, n) {
        var i = !0, o = "width" === t ? e.offsetWidth : e.offsetHeight, s = je(e),
    ...
    C.extend({
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, s, r, a = C.camelCase(t), l = e.style;
        ...
        get: function (e, t) {
            ...
            var n = e.style, i = e.currentStyle, o = C.isNumeric(t) ? "alpha(opacity=" + 100 * t + ")" : "",
        ...
        constructor: Ve, init: function (e, t, n, i, o, s) {
    ...
    var Ge, Ye, Je, Ze, et, tt, nt, it = /^(?:toggle|show|hide)$/,
        ot = new RegExp("^(?:([+-])=|)(" + R + ")([a-z%]*)$", "i"), st = /queueHooks$/, rt = [function (t, e, n) {
            var i, o, s, r, a, l, c, u = this, d = {}, p = t.style, h = t.nodeType && B(t), f = C._data(t, "fxshow");
            ...
            if (C.isEmptyObject(d)) "inline" === ("none" === c ? Ee(t.nodeName) : c) && (p.display = c); else for (i in f ? "hidden" in f && (h = f.hidden) : f = C._data(t, "fxshow", {}), s && (f.hidden = !h), h ? C(t).show() : u.done(function () {
                C(t).hide()
            }), u.done(function () {
                var e;
            ...
            "*": [function (e, t) {
                var n = this.createTween(e, t), i = n.cur(), o = ot.exec(t), s = o && o[3] || (C.cssNumber[e] ? "" : "px"),
                    r = (C.cssNumber[e] || "px" !== s && +i) && ot.exec(C.css(n.elem, e)), a = 1, l = 20;
    ...
    function dt(s, e, t) {
        var n, r, i = 0, o = rt.length, a = C.Deferred().always(function () {
            delete l.elem
        }), l = function () {
            if (r) return !1;
        ...
        for (function (e, t) {
            var n, i, o, s, r;
            for (n in e) if (o = t[i = C.camelCase(n)], s = e[n], C.isArray(s) && (o = s[1], s = e[n] = s[0]), n !== i && (e[i] = s, delete e[n]), (r = C.cssHooks[i]) && "expand" in r) for (n in s = r.expand(s), delete e[i], s) n in e || (e[n] = s[n], t[n] = o); else t[i] = o
        }(u, c.opts.specialEasing); i < o; i++) if (n = rt[i].call(c, s, u, c.opts)) return n;
    ...
    C.Animation = C.extend(dt, {
        ...
        fadeTo: function (e, t, n, i) {
            ...
            var s = C.isEmptyObject(t), r = C.speed(e, n, i);
            ...
            return "string" != typeof o && (s = e, e = o, o = void 0), e && !1 !== o && this.queue(o || "fx", []), this.each(function () {
                var e = !0, t = null != o && o + "queueHooks", n = C.timers, i = C._data(this);
                if (t) i[t] && i[t].stop && r(i[t]); else for (t in i) i[t] && i[t].stop && st.test(t) && r(i[t]);
                for (t = n.length; t--;) n[t].elem !== this || null != o && n[t].queue !== o || (n[t].anim.stop(s), e = !1, n.splice(t, 1));
                !e && s || C.dequeue(this, o)
            })
        }, finish: function (r) {
            return !1 !== r && (r = r || "fx"), this.each(function () {
                var e, t = C._data(this), n = t[r + "queue"], i = t[r + "queueHooks"], o = C.timers,
                    s = n ? n.length : 0;
    ...
    C.fn.extend({
        ...
        valHooks: {
            option: {
                ...
                get: function (e) {
                    for (var t, n, i = e.options, o = e.selectedIndex, s = "select-one" === e.type || o < 0, r = s ? null : [], a = s ? o + 1 : i.length, l = o < 0 ? a : s ? o : 0; l < a; l++) if (!(!(n = i[l]).selected && l !== o || (v.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && C.nodeName(n.parentNode, "optgroup"))) {
                        if (t = C(n).val(), s) return t;
                        r.push(t)
                    }
                    return r
                }, set: function (e, t) {
                    for (var n, i, o = e.options, s = C.makeArray(t), r = o.length; r--;) if (i = o[r], 0 <= C.inArray(C.valHooks.option.get(i), s)) try {
                        i.selected = n = !0
                    } catch (e) {
                        i.scrollHeight
                    } else i.selected = !1;
    ...
    var ht, ft, mt = C.expr.attrHandle, gt = /^(?:checked|selected)$/i, vt = v.getSetAttribute, yt = v.input;
    C.fn.extend({
        attr: function (e, t) {
        ...
        attr: function (e, t, n) {
            ...
            var n, i, o = 0, s = t && t.match(j);
            if (s && 1 === e.nodeType) for (; n = s[o++];) i = C.propFix[n] || n, C.expr.match.bool.test(n) ? yt && vt || !gt.test(n) ? e[i] = !1 : e[C.camelCase("default-" + n)] = e[i] = !1 : C.attr(e, n, ""), e.removeAttribute(vt ? n : i)
        }, attrHooks: {
            type: {
                set: function (e, t) {
    ...
    C.fn.extend({
        addClass: function (t) {
            ...
            if (c) for (e = (t || "").match(j) || []; a < l; a++) if (i = 1 === (n = this[a]).nodeType && (n.className ? (" " + n.className + " ").replace(kt, " ") : " ")) {
            ...
            return "boolean" == typeof t && "string" == s ? t ? this.addClass(o) : this.removeClass(o) : this.each(C.isFunction(o) ? function (e) {
                ...
                if ("string" == s) for (var e, t = 0, n = C(this), i = o.match(j) || []; e = i[t++];) n.hasClass(e) ? n.removeClass(e) : n.addClass(e); else s !== O && "boolean" != s || (this.className && C._data(this, "__className__", this.className), this.className = this.className || !1 === o ? "" : C._data(this, "__className__") || "")
            })
        }, hasClass: function (e) {
    ...
    St = Lt.exec(_t.toLowerCase()) || [], C.extend({
        ...
        ajax: function (e, t) {
            ...
            var n, i, u, d, p, h, f, o, m = C.ajaxSetup({}, t), g = m.context || m,
                v = m.context && (g.nodeType || g.jquery) ? C(g) : C.event, y = C.Deferred(),
                b = C.Callbacks("once memory"), w = m.statusCode || {}, s = {}, r = {}, k = 0, a = "canceled", x = {
                    readyState: 0, getResponseHeader: function (e) {
                        ...
                        var t;
                        if (e) if (k < 2) for (t in e) w[t] = [w[t], e[t]]; else x.always(e[x.status]);
                        return this
                    }, abort: function (e) {
                        var t = e || a;
    ...
    var Qt = 0, Xt = {}, Ut = C.ajaxSettings.xhr();
        ...
        if (!l.crossDomain || v.cors) return {
            send: function (e, s) {
                ...
                r.send(l.hasContent && l.data || null), c = function (e, t) {
                    var n, i, o;
                    if (c && (t || 4 === r.readyState)) if (delete Xt[a], c = void 0, r.onreadystatechange = C.noop, t) 4 !== r.readyState && r.abort(); else {
    ...
    C.offset = {
        setOffset: function (e, t, n) {
            var i, o, s, r, a, l, c = C.css(e, "position"), u = C(e), d = {};
    ...
    var d = function () {
        ...
        return {
            ...
            }, isArray: u.isArray, isFunction: u.isFunction, isObject: u.isPlainObject, isUndefined: function (e) {
                return void 0 === e
            ...
            }, bind: u.proxy, each: function (e, n) {
                u.each(e, function (e, t) {
                    return n(t, e)
                })
            }, map: u.map, filter: u.grep, every: function (n, i) {
                var o = !0;
            ...
            }, mixin: u.extend, identity: function (e) {
                return e
            }, clone: function (e) {
                return u.extend(!0, {}, e)
        ...
        function i(e) {
            ...
            if (e) return t = {
                ...
                transport: null
            }, e = d.isString(e) ? {url: e} : e, (e = d.mixin(t, e)).url || u.error("remote requires url to be set"), e.transform = e.filter || e.transform, e.prepare = function (e) {
                var t, n, i;
        ...
        return function (e) {
            ...
            return t = {
                ...
                return e ? (t = {
                    ...
                    transform: d.identity,
                    transport: null
                }, e = d.isString(e) ? {url: e} : e, (e = d.mixin(t, e)).url || u.error("prefetch requires url to be set"), e.transform = e.filter || e.transform, e.cacheKey = e.cacheKey || e.url, e.thumbprint = "0.11.1" + e.thumbprint, e.transport = e.transport ? o(e.transport) : u.ajax, e) : null
    ...
    var v = function () {
        ...
        return {
            isMsie: function () {
                ...
                return "number" == typeof e
            }, isArray: g.isArray, isFunction: g.isFunction, isObject: g.isPlainObject, isUndefined: function (e) {
                return void 0 === e
            }, isElement: function (e) {
                return !(!e || 1 !== e.nodeType)
            }, isJQuery: function (e) {
            ...
            }, bind: g.proxy, each: function (e, n) {
                g.each(e, function (e, t) {
                    return n(t, e)
                })
            }, map: g.map, filter: g.grep, every: function (n, i) {
                var o = !0;
            ...
            }, mixin: g.extend, identity: function (e) {
                return e
            }, clone: function (e) {
                return g.extend(!0, {}, e)
            }, getIdGenerator: function () {
        ...
        return function (e) {
            ...
            return n = v.mixin({}, i, e), {
                css: (t = {
                    ...
                    }(), classes: n, html: function (e) {
                        return {
                            wrapper: '<span class="' + e.wrapper + '"></span>',
                            menu: '<div class="' + e.menu + '"></div>'
                        }
                    }(n), selectors: function (e) {
                        var n = {};
                        return v.each(e, function (e, t) {
                            n[t] = "." + e
                        }), n
                    }(n)
                }).css, html: t.html, classes: t.classes, selectors: t.selectors, mixin: function (e) {
                    v.mixin(e, t)
                }
            }
        }
        ...
        return r = {
            ...
            _overwrite: function (e, t) {
                ...
                }), this.highlight && a({className: this.classes.highlight, node: o, pattern: i}), g(o)
    ...
    !function () {
        ...
        var e, m, t;
        e = g.fn.typeahead, m = {www: "tt-www", attrs: "tt-attrs", typeahead: "tt-typeahead"}, t = {
            initialize: function (d, p) {
                ...
                return p = v.isArray(p) ? p : [].slice.call(arguments, 1), h = n((d = d || {}).classNames), this.each(function () {
                    ...
                    v.each(p, function (e) {
                        ...
                        return e
                    }(e, h), (o || s) && (t.css(h.css.wrapper), e.css(o ? h.css.input : h.css.inputWithNoHint), e.wrap(t).parent().prepend(o ? n : null).append(s ? i : null)), u = s ? k : w, r = new y({el: e}), a = new b({
                        hint: n,
                        input: e
                    }, h), l = new u({node: i, datasets: p}, h), c = new x({
                        input: a,
                        menu: l,
                        eventBus: r,
    ...
    (o = 0, r = function (e, t) {
        ...
        var n, i, o = this, s = c(e.currentTarget);
        ...
        e = e || 1;
        var t, n, i, o, s, r = this, a = c("img[data-lazy]", r.$slider);
        ...
        var e, t, n, i, o, s = this, r = !1;
        if ("object" === c.type(arguments[0]) ? (n = arguments[0], r = arguments[1], o = "multiple") : "string" === c.type(arguments[0]) && (i = arguments[1], r = arguments[2], "responsive" === (n = arguments[0]) && "array" === c.type(arguments[1]) ? o = "responsive" : void 0 !== arguments[1] && (o = "single")), "single" === o) s.options[n] = i; else if ("multiple" === o) c.each(n, function (e, t) {
            s.options[e] = t
        }); else if ("responsive" === o) for (t in i) if ("array" !== c.type(s.options.responsive)) s.options.responsive = [i[t]]; else {
        ...
        var e, t, n = this, i = arguments[0], o = Array.prototype.slice.call(arguments, 1), s = n.length;
    ...
    i.prototype = {
        init: function () {
            ...
            s(this.element).each(function () {
                ...
                }).addClass("readmore-js-toggle")), i.options.startOpen || t.css({height: e})
            ...
            var o = !1;
            n = s(t).data("collapsedHeight"), s(t).height() <= n ? (n = s(t).data("expandedHeight") + "px", newLink = "lessLink", o = !0, sectionClass = i.options.expandedClass) : (newLink = "moreLink", sectionClass = i.options.collapsedClass), i.options.beforeToggle(e, t, o), s(t).animate({height: n}, {
                duration: i.options.speed,
                complete: function () {
    ...
    var h, f, m = p(window), i = {}, g = [], v = [], y = null, u = "_open", b = [], w = null,
        d = /(iPad|iPhone|iPod)/g.test(navigator.userAgent), k = {
            _init: function (e) {
                var t = p(e), n = t.data("popupoptions");
                ...
                var e, t, i, o, s = p(n), r = p("body"), a = s.data("popupoptions");
                ...
                if (!n.data("popup-visible")) {
                    ...
                    var i = p("body"), o = n.data("popupoptions"), s = p("#" + e.id + "_wrapper"),
                    ...
                    }, 20), o.scrolllock && (i.css("overflow", "hidden"), i.height() > m.height() && i.css("margin-right", y + h)), o.backgroundactive && n.css({top: (m.height() - (n.get(0).offsetHeight + parseInt(n.css("margin-top"), 10) + parseInt(n.css("margin-bottom"), 10))) / 2 + "px"}), n.css({
                        visibility: "visible",
                        opacity: 1
                    }), o.background && (r.css({visibility: "visible", opacity: o.opacity}), setTimeout(function () {
                ...
                if (-1 !== n) {
                    f && clearTimeout(f);
                    var i = p("body"), o = p(t), s = o.data("popupoptions"), r = p("#" + t.id + "_wrapper"),
                    ...
                    }, 0), r.css({visibility: "hidden", opacity: 0}), o.css({
                        visibility: "hidden",
                        opacity: 0
                    }), s.background && a.css({
                        visibility: "hidden",
                ...
                var n = p(e), i = n.data("popupoptions"), o = p("#" + e.id + "_wrapper");
                p("#" + e.id + "_background");
            ...
            var i = p(e).data("popupoptions"), o = i.openelement ? i.openelement : "." + e.id + u,
                s = p(o + '[data-popup-ordinal="' + t + '"]');
            "function" == typeof n && n.call(p(e), e, s)
        };
    p(document).on("keydown", function (e) {
        if (b.length) {
            var t = b[b.length - 1], n = document.getElementById(t);
        ...
        if (b.length && 9 == e.which) {
            var t = b[b.length - 1], n = document.getElementById(t),
                ...
                o = p(":focus"), s = i.length, r = i.index(o);
    ...
    function C(s, r, a) {
        ...
        var e, t, n, c = b(s) || s, o = function e(t) {
            var n, i, o;
    ...
    var H = "undefined" != typeof window,
        ...
        z = H && "IntersectionObserver" in window, q = H && "classList" in document.createElement("p"),
        P = H && 1 < window.devicePixelRatio, M = {
        ...
        }, F = ["IMG", "IFRAME", "VIDEO"], B = ["IMG", "IFRAME"];
    return e.prototype = {
        update: function (e) {
            var t = this._settings, n = D(e, t);
    ...
    "use strict";
    var u = jQuery(window).width(), d = jQuery(window).height(), p = 1024;
    ...
    jQuery.fn.scrollTo = function (e, t) {
        ...
        jQuery(window).resize(function () {
            ...
            return h(".tabs-buttons button").removeClass("is-active"), h(".tabs-contents > div").removeClass("is-active"), h(".login-modal").addClass("is-active"), h(".register-section").addClass("is-active"), h('.tabs-buttons button[data-type="register"]').addClass("is-active"), m("register"), !1
            ...
            return h(".tabs-buttons button").removeClass("is-active"), h(".tabs-contents > div").removeClass("is-active"), h(this).addClass("is-active"), h(".tabs-contents ." + e + "-section").addClass("is-active"), "register" == e && m("register"), !1
        ...
        h(".text-search").bind("keyup", function (e) {
            ...
            h.ajax({
                ...
                data: {
                   ...
                   rep.followed ? t.html('<span class="fa fa-heart"></span> Đang theo dõi') :
                        t.html('<span class="far fa-heart"></span> Theo dõi');
                    follow.text(rep.number);
                }
            })
        });
        var o = 0;
        h(document).on("click", ".btn-like", function () {
            ...
            return h("#list_emoji").removeClass("is-active"), !1
                ...
                if (id_parent > 0 && 0 == h(".comments-container").find(".reply_" + id_parent).length) {
                    var  s = h(h(".main_comment").clone()).insertAfter(h(this)
                        .parent().parent().parent().parent());

                        s.removeClass("main_comment");
                        var mess = s.find('.mess-input');

                        mess.attr('data-parent', id_parent), mess.removeAttr('data-comic');

                        s.addClass("reply_comment"), s.addClass('insert-form')
                        , s.find("textarea").val("").focus()
                        , s.addClass("reply_" + id_parent);
                } else {
                ...
                if(res) {
                    h.ajax({
                        ...
                        success: function() {
                            h(".list-comment .parent_"+id).remove();
                            h(".list-comment .child_" + id).remove();
                            h(".list-comment .insert-form").remove();
                        }
                    });
                }
            ...
            if(content.length > 0){
                h.ajax({
                    ...
                    success: function(e){
                        if(e.action == "comment"){
                            var list = h('.list-comment');
                            list.prepend(e.htmlRender);
                        } else {
                            h('.list-comment .insert-form').remove();
                            var node = h('.list-comment .child_'+e.id_parent);
                            var newNode = document.createElement('article');
                            newNode.innerHTML = e.htmlRender;
                            h(newNode).insertAfter(h('.child_'+e.id_reply));
                        }
                    }
        ...
        // h(document).on('click', '.notify-left', function(e){
        //     var p = h(this);

        //     if(p.hasClass('open')) {
        //         h('.list-notify li').removeClass('unread');
        //     }
        // });

        h(document).on("click", ".load_more_notification", function (e) {
            var div = h(this);
            var from = parseInt(div.data('from')), id_user = div.data('user');
            ...
            if(from != -1) {
                ...
                h.ajax({
                    ...
                    if(e.from == -1) {
                        ...
                        h(".list-notify").append(e.listRender);
                    }
                });
            }
